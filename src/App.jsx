    ...
    <div className=" min-h-screen bg-[#141414] flex justify-center items-center">
      <div className="bg-[#1f1f1f] w-[330px] h-[530px] rounded-lg ">
        <div className="mt-9 text-center text-white ">
          ...
          <button className="text-xs text-gray-100 font-semibold mt-4 bg-[#333333] py-3 w-[270px] rounded-md shadow-sm hover:shadow-md hover:bg-[#c5f82a] hover:text-black transition-all">Fronrend Mentor</button>
